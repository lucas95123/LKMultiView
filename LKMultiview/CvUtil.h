...
/*Image Utility*/
void showImage(string windowName, const Mat &img, int delay=1000);

void showTwoImage(string windowName, const Mat &img1, const Mat &img2, bool isHorizontal, int delay=1000);
